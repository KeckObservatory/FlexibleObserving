...
class Spec:
    def __init__(self):
        self.objEnabled = True     # Is the Obj Frame enabled
        self.skyEnabled = False    # Is the Sky Frame enabled
        self.oriX = 0.0
        # Center of the 
        self.oriY = 0.0
        self.cornerX = -0.16       # Bottom left  corner of box
        self.cornerY = -0.64       # Bottom right corner of box

class Imag:
    def __init__(self):
        self.objEnabled = False
...
class Oopgui:
    def __init__(self):
        ...
        self.ax.set_xticks(np.arange(self.xMin, self.xMax, self.scale))
        self.ax.set_yticks(np.arange(self.yMin, self.yMax, self.scale))
        self.ax.add_patch(
            #self.add_obj_box(0)
